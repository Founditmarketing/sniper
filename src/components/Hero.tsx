  ...
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden bg-ink">
      ...
      <motion.h1 
        ...
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full text-center font-display text-[25vw] leading-[0.75] uppercase text-stroke-thick z-0 pointer-events-none select-none whitespace-nowrap"
      >
        SNIPER
      </motion.h1>
      ...
      {/* Marquee Tape */}
      <div className="absolute bottom-0 left-0 right-0 bg-crimson text-white py-3 z-30 overflow-hidden border-y-2 border-black transform -rotate-1 origin-bottom-left scale-105 shadow-[0_0_30px_rgba(230,0,0,0.3)]">
